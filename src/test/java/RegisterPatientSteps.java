...
public class RegisterPatientSteps {
    ...
    public void i_sending_register_form_to_be_created_with_my_email_bill_gmail_com(String email) {
        Date date= new Date();
        Patient patient = new Patient("1", "username", "password","Luis" ,"Panta", email,date);
        String url=postUrl + "patient/";
    ...
    public void i_sending_register_form_to_be_created_with_an_used_email(String string) {
        Date date= new Date();
        Patient patient = new Patient("1", "username", "password","Luis" ,"Panta", string,date);
        String url=postUrl + "patient/";
